...
//#endregion
//#region ../../packages/ui/src/components/card.tsx
var Card = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx("div", {
	ref,
	className: cn("rounded-2xl border border-white/[0.06] bg-zinc-900 text-zinc-100 transition-[border-color] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-white/[0.12]", className),
	...props
}));
...
var Input = React.forwardRef(({ className, type, ...props }, ref) => {
	return /* @__PURE__ */ jsx("input", {
		type,
		className: cn("flex h-11 w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2 font-body text-sm text-white shadow-sm transition-[border-color,box-shadow] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-zinc-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/30 focus-visible:border-accent-500/40 disabled:cursor-not-allowed disabled:opacity-50", className),
		ref,
		...props
	});
});
...
//#endregion
//#region ../../packages/ui/src/components/badge.tsx
var badgeVariants = cva("inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold font-body transition-colors", {
	variants: { variant: {
...
//#endregion
//#region ../../packages/ui/src/components/avatar.tsx
var sizeClasses = {
	sm: "h-8 w-8 text-xs",
...
function Avatar({ src, alt, fallback, size = "md", className, ...props }) {
	...
	return /* @__PURE__ */ jsx("div", {
		className: cn("relative inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full bg-zinc-800 ring-1 ring-white/[0.06] font-display font-bold text-zinc-400", sizeClasses[size], className),
		...props,
		children: src && !imgError ? /* @__PURE__ */ jsx("img", {
			src,
			alt: alt || "",
			className: "h-full w-full object-cover",
			onError: () => setImgError(true)
		}) : /* @__PURE__ */ jsx("span", { children: fallback || alt?.charAt(0)?.toUpperCase() || "?" })
	});
}
//#endregion
//#region ../../packages/ui/src/components/accordion.tsx
function Accordion({ items, className, variant = "default" }) {
	if (variant === "cards") return /* @__PURE__ */ jsx("div", {
		...
		children: items.map((item) => /* @__PURE__ */ jsxs("details", {
			...
			children: [/* @__PURE__ */ jsxs("summary", {
				className: "flex items-center justify-between cursor-pointer list-none px-6 py-5 font-display font-bold text-[15px] text-white select-none transition-colors duration-150 ease-[cubic-bezier(0.23,1,0.32,1)]",
				children: [/* @__PURE__ */ jsxs("span", {
					className: "flex items-center gap-3",
					children: [/* @__PURE__ */ jsx("span", { className: "h-6 w-0.5 rounded-full bg-zinc-700 group-open:bg-accent-500 transition-colors duration-300" }), item.title]
				...
				className: "px-6 pb-5 pl-[39px] text-sm text-zinc-400 leading-relaxed",
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: items.map((item) => /* @__PURE__ */ jsxs("details", {
			className: "group",
			children: [/* @__PURE__ */ jsxs("summary", {
				className: "flex items-center justify-between cursor-pointer list-none px-0 py-5 font-display font-bold text-white select-none transition-colors duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:text-zinc-300 active:scale-[0.997]",
				children: [item.title, /* @__PURE__ */ jsx(CaretDown, {
					size: 16,
					weight: "bold",
...
//#endregion
//#region ../../packages/ui/src/components/tabs.tsx
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			return /* @__PURE__ */ jsx("button", {
				...
				className: cn("relative z-10 px-4 py-2 text-sm font-medium rounded-xl transition-colors duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] active:scale-[0.97]", isActive ? "text-white" : "text-zinc-400 hover:text-zinc-200"),
				children: tab
			}, tab);
		})]
	});
...
//#endregion
//#region ../../packages/ui/src/auth.tsx
...
//#endregion
export { Avatar as a, Accordion as i, useAuth as n, Badge as o, Tabs as r, Button as s, AuthProvider as t };
