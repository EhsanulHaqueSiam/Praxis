      ...
      <div className="relative mx-auto max-w-7xl px-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <AnimateOnScroll delay={100}>
            <SpotlightCard className="md:row-span-2 h-full rounded-2xl border border-white/[0.06] bg-zinc-900 p-6 md:p-8 hover:border-white/[0.12] transition-[border-color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] flex flex-col card-highlight">
          ...
          <AnimateOnScroll delay={200}>
            <SpotlightCard className="rounded-2xl border border-white/[0.06] bg-zinc-900 p-6 md:p-8 hover:border-white/[0.12] transition-[border-color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] card-highlight">
            ...
            <SpotlightCard className="rounded-2xl border border-white/[0.06] bg-zinc-900 p-6 md:p-8 hover:border-white/[0.12] transition-[border-color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] card-highlight">
              <div className="relative z-10">
                ...
                <div className="font-mono text-xs space-y-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-accent-500 animate-pulse" style={{ animationDelay: "0.5s" }} />
                    <span className="text-zinc-400">
          ...
          <AnimateOnScroll delay={200} className="md:col-span-2 lg:col-span-1">
            <SpotlightCard className="rounded-2xl border border-white/[0.06] bg-zinc-900 p-6 md:p-8 hover:border-white/[0.12] transition-[border-color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] card-highlight">
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  <div className="h-10 w-10 rounded-xl bg-zinc-800 flex items-center justify-center">
