...
- [x] 01-02-PLAN.md — Migrate web marketing components + category taxonomy + learning paths + JSON-LD
- [x] 01-03-PLAN.md — Migrate dashboard app components + replace all "217" references
